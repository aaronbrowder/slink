 ...
 */
function hook_forum_notification_recipients_alter(&$recipients, EntityInterface $node) {
 ...
 * @param \Drupal\Core\Entity\EntityInterface $node
 */
function hook_forum_notification_params_alter(&$params, EntityInterface $node) {
