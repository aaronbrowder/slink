...
/**
 * Plugin implementation of the 'address_short' formatter.
 *
 * @FieldFormatter(
 *   id = "address_short",
 ...
 * )
 */
class AddressShortFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs an AddressShortFormatter object.
   *
