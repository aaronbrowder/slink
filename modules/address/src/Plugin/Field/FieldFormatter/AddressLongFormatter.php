...
/**
 * Plugin implementation of the 'address_long' formatter.
 *
 * @FieldFormatter(
 *   id = "address_long",
 ...
 * )
 */
class AddressLongFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs an AddressLongFormatter object.
   *
